...
const routes = [
  { from: "New York", to: "London", class: "Business Class", price: "$2,050", retail: "$6,100", saving: 66 },
  { from: "Los Angeles", to: "Paris", class: "Business Class", price: "$2,267", retail: "$5,600", saving: 59 },
  { from: "Chicago", to: "Frankfurt", class: "Business Class", price: "$1,890", retail: "$4,700", saving: 60 },
  { from: "San Francisco", to: "Zurich", class: "First Class", price: "$3,900", retail: "$9,200", saving: 58 },
];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {routes.map((route, index) => (
            <FadeUp key={`${route.from}-${route.to}`} delay={index * 0.08}>
              <div className="bg-card border border-border rounded-lg p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 hover:border-gold/20 hover:shadow-gold-glow transition-all duration-500">
