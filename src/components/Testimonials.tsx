...
const testimonials = [
  {
    quote: "Magnus Privé saved us over $12,000 on our executive team's London trip. The service was impeccable from start to finish.",
    author: "Sarah Mitchell",
    title: "VP of Operations",
    company: "Apex Ventures",
  },
  {
    quote: "As a touring manager, I need reliable last-minute bookings. Magnus Privé delivers every time with rates I can't find anywhere else.",
    author: "Marcus Chen",
    title: "Tour Manager",
